export default {
  ...
  uploadTimeout: {
    largeFileUploadReminder: '大文件上传提醒',
    batchUploadReminder: '批量上传提醒',
    uploadReminder: '上传提醒',
    timeoutWarning: '上传超时警告',
    timeoutDescription: '系统已为您的上传任务设置了智能超时时间，请保持网络连接稳定。',
    timeoutExceededDescription: '预计上传时间超过系统超时限制，建议分批上传或检查网络连接。',
    estimatedUploadTime: '预计上传时间：',
    timeoutLimit: '超时限制：',
    networkSuggestion: '网络建议：',
    aboutSeconds: '约 {seconds} 秒',
    aboutMinutes: '约 {minutes} 分钟',
    aboutHours: '约 {hours} 小时',
    minutes: '{minutes} 分钟',
    useWiredNetwork: '建议使用有线网络或稳定的WiFi',
    batchUploadSuggestion: '建议分批上传，每批不超过30个文件',
    keepStableConnection: '保持网络连接稳定',
    currentNetworkSpeed: '当前网速：',
    speedTestFailed: '网速测量失败，以下为预估值仅供参考',
  },
};
